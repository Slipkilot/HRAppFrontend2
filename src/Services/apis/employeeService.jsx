...
export const getEmployees = () => async (dispatch) => {
  ...
  try {
    const { data } = await axios.get(
      `https://hrappbackendwebapi20240119093404.azurewebsites.net/api/Admin/GetAllEmployees`
    );
...
export const getEmployeeDetail = (id) => async (dispatch) => {
  ...
  try {
    const { data } = await axios.get(
      `https://hrappbackendwebapi20240119093404.azurewebsites.net/api/Admin/GetDetails?appUserId=${id}`
    );
...
export const getEmployeeUpdateDetail = (id) => async (dispatch) => {
  ...
  try {
    const { data } = await axios.get(
      `https://hrappbackendwebapi20240119093404.azurewebsites.net/api/Admin/GetUserUpdateDetails?appUserId=${id}`
    );
...
export const editEmployee = async (id, datas, callback) => {
  ...
  try {
    const response = await axios.put(
      `https://hrappbackendwebapi20240119093404.azurewebsites.net/api/Admin/UpdateEmployee?id=${id}`,
      datas,
      {
        headers: {
...
export const getJobs = () => async (dispatch) => {
  ...
  try {
    const { data } = await axios.get(
      `https://hrappbackendwebapi20240119093404.azurewebsites.net/api/Admin/GetDepartmentsAndProfessions`
    );
...
export const addEmployee = async (datas, callback) => {
  ...
  try {
    const response = await axios.post(
      `https://hrappbackendwebapi20240119093404.azurewebsites.net/api/Admin/AddEmployee`,
      datas,
      {
        headers: {
          "Content-Type": "multipart/form-data",
