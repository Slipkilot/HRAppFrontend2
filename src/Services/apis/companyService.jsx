...
export const companyAdd = async (admindata, companyData, callback) => {
  ...
  try {
    const response = await axios.post(
      `https://hrappbackendwebapi20240119093404.azurewebsites.net/api/Company/CreateCompany/`,
      formData,
      {
        headers: {
...
export const companiesGet = () => async (dispatch) => {
  ...
  try {
    const { data } = await axios.get(
      `https://hrappbackendwebapi20240119093404.azurewebsites.net/api/Company/GetCompanys`
    );
...
export const companyDelete = async (id, callback) => {
  ...
  try {
    const response = await axios.delete(
      `https://hrappbackendwebapi20240119093404.azurewebsites.net/api/Company/DeleteCompany?companyId=${id}`
    );
    message = response.data;
  } catch (error) {
    if (error.response && error.response.data)
...
export const stopSubscription = async (id, callback) => {
  ...
  try {
    const response = await axios.put(
      `https://hrappbackendwebapi20240119093404.azurewebsites.net/api/Company/StopSubscription?companyId=${id}`
    );
    message = response.data;
  } catch (error) {
    if (error.response && error.response.data)
...
export const extendSubscription = async (data, callback) => {
  ...
  try {
    const response = await axios.put(
      `https://hrappbackendwebapi20240119093404.azurewebsites.net/api/Company/ExtendSubscription`,
      data
    );
    message = response.data;
  } catch (error) {
...
export const companiesDetailGet = (id) => async (dispatch) => {
  ...
  try {
    const { data } = await axios.get(
      `https://hrappbackendwebapi20240119093404.azurewebsites.net/api/Company/GetCompanyUpdateDetails?companyId=${id}`
    );
...
export const companyUpdate = async (id, data, callback) => {
  ...
  try {
    const response = await axios.put(
      `https://hrappbackendwebapi20240119093404.azurewebsites.net/api/Company/UpdateCompany?companyId=${id}`,
      formData,
      {
        headers:{
          "Content-Type": "multipart/form-data"
